       ...
       ===================================================== */
    {
        ...
        tagline:
            "The mountain keeps its old claims.",

        seat:
            "Vault Ozobell",

        sovereign:
            "King Trofin Ozyhammer the 290th",
        ...
        politics:
            "Dwarven society is divided among great Houses, each associated with a major metal or material. The Houses are ranked in descending station: Ozythril, Platinum, Gold, Silver, Copper, Iron, Lead, and Stone. The King of Bell is always chosen from House Ozythril. The current ruler is King Trofin Ozyhammer the 290th, who rules from Vault Ozobell. Rank is carried through lineage, and the standing of a Dwarven family can often be understood by the rank into which its children are born. Great shame can strip a lineage of its inherited standing. When this occurs, the disgraced line is removed from its former place, and the next child begins again as the first of their father's name.",

        economics:
            "Bell's ancient mines no longer provide the abundance of precious metals for which the Dwarves were once famous. Instead, the kingdom depends heavily upon reclamation. Metal gathered from the surface world is brought into enormous mountain refineries, where broken tools, weapons, machinery, ornaments, scrap, and other objects are melted down and reused. Metalworking remains central to Bell's wealth and identity, but modern Dwarven industry increasingly depends upon recovering what the rest of Ozyleme has already used.",

        society:
            "Dwarven identity in Bell is inseparable from House, lineage, station, and service. Each major House is associated with a metal or material and occupies a recognized position within the social order. House Iron traditionally acts as one of Bell's great defensive Houses. Its members guard the approaches closest to the surface and protect the entrances to the mountain Vaults. Stories claim that House Iron deals with its greatest dangers in a particularly terrible fashion. Threats too dangerous to destroy are sealed inside impenetrable casts of armor, where they remain until the end of their days. The sounds of industry are nearly constant throughout Bell. Generations of Dwarves grow accustomed to sleeping beneath the distant ringing of anvils and the deep concussion of refinery hammers. Beneath all of this is a culture intensely conscious of ancestry. A Dwarf does not merely carry a personal name, but the weight, honor, or disgrace of the line that came before.",
